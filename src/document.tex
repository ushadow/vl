...
\cite{freeman95} uses histogram of local orientations, a precursor of HOGs for
hand pose recognition.

\subsection{Recognition Gestures with Distinct Paths}
...
each state generates an observation (i.e. the feature vector). This process
...
If we have ground truth label, we can train the three phases separately
embeded training or 

Incorporate hand pose gesture 
